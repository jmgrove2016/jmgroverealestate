...
function jm_form_func(  ) {
	
    $jm_form_html = '<div class="form-inner">
            <div class="button-group">
                <input type="button" class="active_page" value="For Sale">
                <input type="button"  value="For Lease">
                <input type="button"  value="Agents">
                <input type="button"  value="Offices">
             </div>
            <div class="clear"></div>
            <div class="search-section">
            <input type="search" class="search ">
                <i class="fa fa-search fa-2x find-icon icon-section"></i>
                            
                <i class="fa fa-filter fa-2x filter icon-section"></i>
            </div>
...
add_shortcode( 'jm_form', 'jm_form_func' );
